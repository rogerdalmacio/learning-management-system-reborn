...
function AdminSingleGrantExam() {
  ...
  const SubmitButton = () => {
    ...
    if (
      ...
      axios
        .post(
          `${import.meta.env.VITE_API_BASE_URL}/api/core/singlegrantexam`,
          item,
          {
            headers: {
      ...
      <div className="mb-4">
        ...
        <div id="dropdown" className="dropdown">
          ...
          <ul className="dropdown-menu w-100">
            <li
              className={`${
                preliminariesValue == "Preliminary Exam" ? "d-none" : "d-block"
              }`}
            >
              <button
            ...
            <li
              className={`${
                preliminariesValue == "Midterm Exam" ? "d-none" : "d-block"
              }`}
            >
              <button
                value="Midterm Exam"
            ...
            <li
              className={`${
                preliminariesValue == "Finals Exam" ? "d-none" : "d-block"
              }`}
            >
              <button
                value="Finals Exam"
