...
function GetActivitiesSortBySubjects() {
  ...
  const AvailableCourseHandler = () => {
    return TeacherSubjects.map((subject, i) => {
      ...
      return (
        <div key={i}>
          <Link
            to={`/teacher/studentsActivities/${subject}`}
  ...
  return (
    <Fragment>
      <ArrowNextAndPrevious>
        <h2 className="mb-0">Student's Activities - Subject/s</h2>
      </ArrowNextAndPrevious>
...
export default GetActivitiesSortBySubjects;
