...
function GetActivitiesSortBySection() {
  ...
  const AvailableCourseHandler = () => {
    return TeacherSection.map((section, i) => {
      ...
      return (
        <div key={i}>
          <Link
            to={`/teacher/studentsActivities/${courseBase}/${section}`}
  ...
  return (
    <Fragment>
      <ArrowNextAndPrevious>
        <h2 className="mb-0">Student's Activities - Section/s</h2>
      </ArrowNextAndPrevious>
...
export default GetActivitiesSortBySection;
