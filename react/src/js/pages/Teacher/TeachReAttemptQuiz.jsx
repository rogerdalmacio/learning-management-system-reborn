                        ...
                        const result2 = numbers.map((num) => {
                            ...
                            return data.map((item) => {
                                ...
                                return filteredItem.reduce((acc, cur) => {
                                    ...
                                    const weekNo = parseInt(
                                        cur.module_id.split("-")[1],
                                        10
                                    );
                                    ...
                                    const resul = {
                                        ...
                                        evaluation:
                                            acc.evaluation == undefined
                                                ? ""
                                                : acc.evaluation,
                                        aae:
                                            acc.aae == undefined ? "" : acc.aae,
                                        assignment:
                                            acc.assignment == undefined
                                                ? ""
                                                : acc.assignment,
                                        prelim_examination:
                                        ...
                                        weekNo:
                                            acc.weekNo == undefined
                                                ? ""
                                                : acc.weekNo,
                                        evaluationid:
                                            acc.evaluationid == undefined
                                                ? ""
                                                : acc.evaluationid,
                                        aaeid:
                                            acc.aaeid == undefined
