...
function ValidateSnapSortBySection() {
  ...
  const AvailableCourseHandler = () => {
    return TeacherSection.map((section, i) => {
      ...
      return (
        <div key={i}>
          <Link
            to={`/teacher/validatesnapshot/${courseBase}/${section}`}
  ...
  return (
    <Fragment>
      <ArrowNextAndPrevious>
        <h2 className="mb-0">Validate Snapshot - Section/s</h2>
      </ArrowNextAndPrevious>
...
export default ValidateSnapSortBySection;
