...
function ValidateSnapSortBySubjects() {
  ...
  const AvailableCourseHandler = () => {
    return TeacherSubjects.map((subject, i) => {
      ...
      return (
        <div key={i}>
          <Link
            to={`/teacher/validatesnapshot/${subject}`}
  ...
  return (
    <Fragment>
      <ArrowNextAndPrevious>
        <h2 className="mb-0">Validate Snapshot - Subject/s</h2>
      </ArrowNextAndPrevious>
...
export default ValidateSnapSortBySubjects;
