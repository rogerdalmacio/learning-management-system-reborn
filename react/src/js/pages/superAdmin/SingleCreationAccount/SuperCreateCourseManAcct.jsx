...
const SuperCreateCourseManAcct = () => {
      ...
      if (role === "SuperAdmin") {
        await axios
          ...
          .then((response) => {
            ...
            setGetAnnouncement(response.data.CourseManagers);
            setTableData(
              response.data.CourseManagers.sort((a, b) => b.id - a.id)
            );
          });
      }
    };
  ...
  return (
    <Fragment>
      <ArrowNextAndPrevious>
        <h3 className="m-0">Course Manager Creation of Account</h3>
      </ArrowNextAndPrevious>
    ...
    if (
      ...
      await axios
        .post(
          `${
            import.meta.env.VITE_API_BASE_URL
          }/api/core/createsinglecoursemanager`,
          userInformation,
          {
            headers: {
              Authorization: `Bearer ${token}`,
