...
function FileUpload() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!file) {
            ...
            axios
                .post("/api/core/createaccount", formData, {
                    headers: {
            ...
            >
                ...
                {file && (
                    <div className="fileNameContainer mt-3 py-1 px-2">
                        <i className="fileUploadCancelBtn bi bi-x text-right"></i>
                        ...
                        <div className=" d-sm-flex align-items-center">
                            ...
                            <div className="SizeAndLoading d-flex align-items-center">
                                {ConvertSizeHandler()}
                            </div>
                            <div className="fileStateIcon text-center">
                                {FileStateIcon()}
                            </div>
                        </div>
                    </div>
